...
class FragmentSessionUtils private constructor() {
    ...
    fun switchFragment(fragmentManager: FragmentManager, fragment: Fragment, addToBackStack: Boolean = false) {
        ...
        val navHostContainer = R.id.nav_host_fragment
...
if (currentFragment !is HymnBookItemFragment)
